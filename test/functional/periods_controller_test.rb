...
class PeriodsControllerTest < ActionController::TestCase
  ...
  test "should create period" do
    assert_difference('Period.count') do
      post :create, period: { from_date: @period.from_date, from_time: @period.from_time, to_date: @period.to_date, to_time: @period.to_time }
    end
  ...
  test "should update period" do
    put :update, id: @period, period: { from_date: @period.from_date, from_time: @period.from_time, to_date: @period.to_date, to_time: @period.to_time }
    assert_redirected_to period_path(assigns(:period))
  end
