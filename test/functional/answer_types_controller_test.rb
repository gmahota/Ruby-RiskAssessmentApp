...
class AnswerTypesControllerTest < ActionController::TestCase
  ...
  test "should create answer_type" do
    assert_difference('AnswerType.count') do
      post :create, answer_type: { impact_id: @answer_type.impact_id, name: @answer_type.name, value: @answer_type.value }
    end
  ...
  test "should update answer_type" do
    put :update, id: @answer_type, answer_type: { impact_id: @answer_type.impact_id, name: @answer_type.name, value: @answer_type.value }
    assert_redirected_to answer_type_path(assigns(:answer_type))
  end
