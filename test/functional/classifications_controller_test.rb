...
class ClassificationsControllerTest < ActionController::TestCase
  ...
  test "should create classification" do
    assert_difference('Classification.count') do
      post :create, classification: { impact_id: @classification.impact_id, name: @classification.name, value: @classification.value }
    end
  ...
  test "should update classification" do
    put :update, id: @classification, classification: { impact_id: @classification.impact_id, name: @classification.name, value: @classification.value }
    assert_redirected_to classification_path(assigns(:classification))
  end
